...
const ContactList = () => {
    const { 
        menuOpen, setMenuOpen, setFormOriginal, setFormOpen, setEdit, list, setList, setForm, formEntity, setLoadingShow
    } = useContext(Mediator);
    ...
    const handlePaginatioClick = (number) => {
        ...
        api.request('/api/contact?page='+number, 'GET')
            .then(res => {
                if (res.status===200 || res.status===201){ // success
                    setList(res.data.data);
                }
        ...
        <div className='c-main-content container-fluid'>
            <div className='c-list'>
                <div className='c-list-head d-flex'>
                    ...
                    <div className='c-list-head-title mr-auto'>Contact cards</div>
